	...
	namespace SIMD {
		public struct Vector3f {
			...
			public static Vector3f Add(Vector3f left, Vector3f right) {
				Float[] l = new Float[8] { left.x, left.y, left.z, 0, 0, 0, 0, 0 };
				Float[] r = new Float[8] { right.x, right.y, right.z, 0, 0, 0, 0, 0 };
				Vector<Float> vl = new Vector<Float>(l);
				Vector<Float> vr = new Vector<Float>(r);
				Vector<Float> vres = vl + vr;
				return new Vector3f(vres[0], vres[1], vres[2]);
			}
			public static Vector3f Add(Vector3f left, Float right) {
				Float[] l = new Float[8] { left.x, left.y, left.z, 0, 0, 0, 0, 0 };
				Float[] r = new Float[8] { right, right, right, 0, 0, 0, 0, 0 };
				Vector<Float> vl = new Vector<Float>(l);
				Vector<Float> vr = new Vector<Float>(r);
				Vector<Float> vres = vl + vr;
				return new Vector3f(vres[0], vres[1], vres[2]);
			...
			public static Vector3f Sub(Vector3f left, Float right) {
				Float[] l = new Float[3] { left.x, left.y, left.z };
				Float[] r = new Float[3] { right, right, right };
				Vector<Float> vl = new Vector<Float>(l);
				Vector<Float> vr = new Vector<Float>(r);
				Vector<Float> vres = vl - vr;
				return new Vector3f(vres[0], vres[1], vres[2]);
			...
			public static Vector3f Div(Float left, Vector3f right) {
				Float[] l = new Float[8] { left, left, left, 0, 0, 0, 0, 0 };
				Float[] r = new Float[8] { right.x, right.y, right.z, 0, 0, 0, 0, 0 };
				Vector<Float> vl = new Vector<Float>(l);
				Vector<Float> vr = new Vector<Float>(r);
				Vector<Float> vres = vl / vr;
